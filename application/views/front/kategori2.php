              ...
              <div class="card shadow-sm" style="border-radius: 10px;">
                <div class="d-flex justify-content-end mt-2">
                    <ol class="breadcrumb" style="margin-right: 50px;">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Kategori 2</li>
                    </ol>
                </div>
                <div class="card-body" style="margin-left: 20px; margin-right: 20px; margin-bottom: 50px; margin-top: 20px;">
    
                  <!-- isinya -->
                  <h5  style="color:rgb(10, 43, 190);"> lowongan kategori 2 </h5> <br>
                  <h5 class="card-title">Lowongan PT Allbest</h5>
                  <p class="card-text">PT Allbest merupakan perusahaan Startup e-commerce. perusahaan ini berdiri pada tahun 1990 tepatnya di kota Jakarta. perusahaan ini merupakan salah satu e-commerce terbesar di Indonesia yang membuat perusahaan e-commerce ini semakin maju. membutuhkan contumer service e-commerce yang memiliki kemampuan komunikasi yang baik.</p>
                  ...
                  <ul>
                    ...
                    <li>Memiliki kemampuan menginput data dengan cepat</li>
                    <li>Memiliki kemampuan komunikasi yang baik</li>
                    <li>Detail, rapi, & teliti</li>
                  </ul>
                  <p>Berminat hubungi email kami di: AllbestCom@gmail.com</p>
                  <p>29 Desember 2020</p>
                </div>
              </div>
            </div>
