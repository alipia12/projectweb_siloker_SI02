                  ...
                  <div class="card shadow-sm" style="border-radius: 10px;">
                    <div class="d-flex justify-content-end mt-2">
                        <ol class="breadcrumb" style="margin-right: 50px;">
                         ...
                         <li class="breadcrumb-item"><a href="<?php echo base_url()?>index.php/welcome/berita">Berita</a></li>
                         <li class="breadcrumb-item active" aria-current="page">Berita 2</li>
                        </ol>
                      </div>
                    <div class="card-body" style="margin-left: 20px; margin-right: 20px; margin-bottom: 50px; margin-top: 20px;">
                      ...
                      <!-- isinya -->
                         <!-- isinya -->
                         <h3  style="text-align: center; color:rgb(10, 43, 190);"> Studi Ekskursi 2019 STTNF Kunjungi Tokopedia </h3> <br>
                         <div  align="justify" class="m-1">
                             <img src="<?php echo base_url()?>/image/nf.jpg" class="m-5 justify-content-center" width="600" height="300" />
                             <p> DepokNews–Rabu (13/2), setelah berkunjung ke Pusat Penelitian Informatika (P2I) LIPI, Cibinong-Bogor selanjutnya mahasiswa STT-NF berkesempatan berkunjung ke Tokopedia Tower, Ciputra-Jakarta Selatan. Tepatnya di Auditorium Tokopedia beberapa pemateri dari Tokopedia menjelaskan mengenai Company Profile, Software Engineer, dan Event Product Academy. Sebelum pemateri dari Tokopedia, Ketua dari STT Terpadu Nurul Fikri yaitu Dr. Lukman Rosyidi, S.T., M.M., M.T. berkesempatan memberikan motivasi dan pengarahan kepada mahasiswa STT-NF.  </p>
                             <p> Selanjutnya pemateri dari Tokopedia, Johanes menjelaskan mengenai Company Profile Tokopedia. Ia menjelaskan tentang ruang lingkup budaya organisasi dari Tokopedia yang menerapkan (Collaborative Culture: equal, same goal, dan priority), (Supportive Ecosystem), dan (Dynamic Environment). Selain itu, Johanes berbagi cerita awal berkarir di Tokopedia. </p>
                        </div>
