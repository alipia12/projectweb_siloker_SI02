...
<body style="background-color: lightgray;">
	<div class="container-fluid mb-2">
        ...
        <div class="row" style="margin-top: 50px; margin-bottom: 50px; margin-left: 15px;">
            <div class="col-sm-8">
              <div class="card shadow-sm" style="border-radius: 10px;">
                <div class="d-flex justify-content-end mt-2">
                    <ol class="breadcrumb" style="margin-right: 50px;">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url()?>index.php/welcome/lowongan">Lowongan Kerja Baru</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Kategori 1</li>
                    </ol>
                </div>
                <div class="card-body" style="margin-left: 20px; margin-right: 20px; margin-bottom: 50px; margin-top: 20px;">
    
                  <!-- isinya -->
                  <h5  style="color:rgb(10, 43, 190);"> lowongan kategori 1 </h5> <br>
                    <h5 class="card-title">Lowongan PT JAYA</h5>
                    <p class="card-text"> salah satu perusahaan yang bergerak di bidang Teknologi yang bertempat di Bandung, Jawa Barat. perusahaan ini memiliki banyak pengalaman diantaranya yaitu membangun Sistem Informasi dan Database, Aplikasi berbasis android/ios dan web dan masih banyak lagi. membutuhkan professional IT Database yang
                    berkompeten, semangat tinggi dalam berkerja, dan dapat berkerja sama dengan baik.</p>
                    ...
                    <ul>
                      ...
                      <li>Menguasai Syntax Query dan management database serta dapat melakukan backup, restore dan replikasi database</li>
                      <li>Pengalaman dengan Failover Cluster, Database Log Shiping dan Database Mirroring</li>
                      <li>Pengalaman dengan Windows Server, MS SQL Server, optimalisasi performance, optimalisasi SQL dan troubleshooting</li>
                      <li>Bersedia response dan trouble shoot di luar jam kerja termasuk hari libur nasional</li>
                    </ul>
                    <p>Berminat hubungi email kami di: ptjaya@gmail.com</p>
                    <p>4 januari 2021</p>
                </div>
              </div>
            </div>
