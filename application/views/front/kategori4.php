              ...
              <div class="card shadow-sm" style="border-radius: 10px;">
                <div class="d-flex justify-content-end mt-2">
                    <ol class="breadcrumb" style="margin-right: 50px;">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">Kategori 4</li>
                    </ol>
                </div>
                <div class="card-body" style="margin-left: 20px; margin-right: 20px; margin-bottom: 50px; margin-top: 20px;">
    
                  <!-- isinya -->
                  <h5  style="color:rgb(10, 43, 190);">lowongan kategori 4 </h5> <br>
                  <h5>PT Fortuone</h5>
                  <p> Saat ini membuka lowongan untuk posisi admin project management, persyaratan dan tanggung jawab </p>
                  
                  <p>Kualifikasi</p>
                  <ul>
                    <li>Lulus D3 / S1 (jurusan apa saja)</li>
                     <li>Pengalaman handle administrasi project diutamakan, kuat dalam analisa data, problem solving, </li>
                    <li>Memiliki perhatian terhadap hal detail, punya kemampuan penjualan, dapat mengoperasikan Microsoft Office dengan baik</li>
                    <li>Bisa bahasa Inggris</li>
                    <li>Terbiasa dengan data analys dan formula excel</li>
                  </ul>
                  <p>Berminat hubungi email kami di: fortu1company@gmail.com</p>
