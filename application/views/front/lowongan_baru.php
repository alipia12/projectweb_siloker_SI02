		...
		<div class="col-sm-8">
		  <div class="card shadow-sm" style="border-radius: 10px;">
			...
			<div class="card-body" style="margin-left: 50px;">
				...
				<p>4 januari 2021, <a href="<?php echo base_url()?>index.php/welcome/detail1">Lihat Detail</a></p>
				<hr />
				...
				<p>29 Desember 2020, <a href="<?php echo base_url()?>index.php/welcome/detail2">Lihat Detail</a></p>
			</div>
		  </div>
		</div>
		<div class="col-sm-4 mt-2">
		  <ul class="list-group">
			...
			<li class="list-group-item"> 
				<a href="<?php echo base_url()?>index.php/welcome/kategori1" >Kategori 1</a>
			</li>
			<li class="list-group-item"> 
				<a href="<?php echo base_url()?>index.php/welcome/kategori2" >Kategori 2</a>
			</li>
			<li class="list-group-item"> 
				<a href="<?php echo base_url()?>index.php/welcome/kategori3" >Kategori 3</a>
			</li>
			<li class="list-group-item"> 
				<a href="<?php echo base_url()?>index.php/welcome/kategori4" >Kategori 4</a>
			</li>
